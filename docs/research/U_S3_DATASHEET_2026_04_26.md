...
# Predicted experimental signature — U@S₃

**SMILES**: `[U][S]1[S][S]1`   **Formula**: S3U   **Atoms**: 4
...
## Energetics
- Total atomization D_at = **13.803 eV**  (3.451 eV/atom)
- Cap binding energy: **4.609 eV**
- Lowest fragmentation barrier: **4.609 eV**

**Fragmentation channels (ΔE in eV; lowest = activation energy):**
  - ΔE = **+13.80** eV  →  [U] + [S] + [S] + [S]  (total atomization (4 atoms))
  - ΔE = **+4.61** eV  →  [U] + [S]1[S][S]1  (cap removal: M @ X_n → M + X_n) ← *lowest*
  - ΔE = **+11.33** eV  →  [U] + [S][S] + [S]  (full ring fragmentation: M + X₂ + X)
...
_Uranium-capped sulfur triangle — chalcogenide analog of Bi₃@U_
...
- **Predicted cap binding:** 4.61 eV — synthesis margin OK at < 200 °C
...
| Photoionization | IE = **6.19 ± 0.2 eV** | VUV synchrotron source |
...
3. Cap binding ≥ 3.2 eV by TGA-MS or thermal decomposition. Below this, the f-block back-donation channel R₅₇ is overestimated.
